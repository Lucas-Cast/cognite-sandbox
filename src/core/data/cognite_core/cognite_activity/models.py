...
from ..models import CogniteActivity


class CogniteActivityAggregation(AggregatedViewInstance):
    view_config = {
        "view_external_id": "CogniteActivity",
...
__all__ = ["CogniteActivity", "CogniteActivityAggregation"]
