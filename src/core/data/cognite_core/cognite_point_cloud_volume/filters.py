...
CognitePointCloudVolumeFilter = TypedDict(
    "CognitePointCloudVolumeFilter",
    {
        ...
        "volumeReferences": StringListFilter,
        "volumeType": StringFilter,
        "OR": "list[CognitePointCloudVolumeFilter]",
        "AND": "list[CognitePointCloudVolumeFilter]",
        "NOT": "CognitePointCloudVolumeFilter",
    },
    total=False,
)
