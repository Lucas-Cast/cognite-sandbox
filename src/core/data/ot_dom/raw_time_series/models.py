...
from ..models import RawTimeSeries


class RawTimeSeriesAggregation(AggregatedViewInstance):
    view_config = {
        "view_external_id": "RawTimeSeries",
    ...
    reset_type: InstanceId | None = None
...
__all__ = ["RawTimeSeries", "RawTimeSeriesAggregation"]
